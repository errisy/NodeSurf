...
class SurfaceSearchOptions {
    constructor(hydrophilicFactor?: number, hydrophobicFactor?: number, testRadius?: number, defaultRadius?:number) {
        if (typeof hydrophilicFactor == 'number' && !isNaN(hydrophilicFactor)) this.hydrophilicFactor = hydrophilicFactor;
        if (typeof hydrophobicFactor == 'number' && !isNaN(hydrophobicFactor)) this.hydrophobicFactor = hydrophobicFactor;
    ...
    public hydrophilicFactor: number = 0.75;
    public hydrophobicFactor: number = 1.333333;
    /**
                ...
                switch (at.type) {
                    ...
                    default:
                        ...
                        for (var WaterRadius = 0.01; WaterRadius <= 0.33; WaterRadius += 0.005) {
                            ...
                            let AtomReach: number;
                            if (at.isHydrophilic) {
                                AtomReach = (CenterAtomRadius + WaterRadius) * options.hydrophilicFactor + WaterRadius * options.hydrophobicFactor;
                            }
                            else {
                                AtomReach = (CenterAtomRadius + WaterRadius) * options.hydrophobicFactor + WaterRadius * options.hydrophobicFactor;
                            }
                             // the atom can approach AtomRadius * Factor + Diameter of Water
